...
@Component({
  selector: 'app-segment-detait-list',
  templateUrl: './segment-detait-list.component.html',
  styleUrls: ['./segment-detait-list.component.scss']
})
export class SegmentDetaitListComponent {
