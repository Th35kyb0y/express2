...
@Component({
  selector: 'app-cs-inbound-customers',
  templateUrl: './cs-inbound-customers.component.html',
  styleUrls: ['./cs-inbound-customers.component.scss',
    '../../../../../assets/CS/cs-new.scss'
  ]
})
export class CsInboundCustomersComponent implements OnInit {
  list: any = [];
	data:any = [];
  filterObj={
		EmpCode:'',
  ...
  getRegistredUserWithFilter() {
    ...
    //   }
      ...
      this.ApiService.httpost(this.filterObj, "/UserMaster/GetCSCustomersRegistration").subscribe(
        (response: any) => {
