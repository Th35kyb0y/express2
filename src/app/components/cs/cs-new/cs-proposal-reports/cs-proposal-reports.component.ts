...
@Component({
  selector: 'app-cs-proposal-reports',
  templateUrl: './cs-proposal-reports.component.html',
  styleUrls: ['./cs-proposal-reports.component.scss',
  '../../../../../assets/CS/cs-new.scss'
  ],
  providers:[Location]
})
export class CsProposalReportsComponent  implements OnInit{
  list: any[] = [];
  ...
  constructor(
    ...
    private location: Location,private CartService :CartService,private toast:ToastService,public excelDownloadService:ExcelDownloadService ){
