...
@Component({
  selector: 'app-risk-area-projection-detait-list',
  templateUrl: './risk-area-projection-detait-list.component.html',
  styleUrls: ['./risk-area-projection-detait-list.component.scss']
})
export class RiskAreaProjectionDetaitListComponent {
  ...
  getSegment() {
    debugger
    this.ApiService.httpgetMaster("", "/AreaMaster/GetAreaApplication").subscribe(
    {
      next:(response:any)=>{
