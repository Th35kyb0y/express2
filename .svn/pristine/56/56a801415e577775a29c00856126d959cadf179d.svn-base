...
// import { TransformerEntity } from 'src/app/models/proposal/cqrs';
...
//   transformerData: TransformerEntity;
//   transformerTableData: TransformerEntity[] = [];
//   options: string[] = [];
//   selectedItems: any[] = [];
//   newItem: string = '';
...
//     this.transformerData = new TransformerEntity();
...
//   onSubmit()
//   {
//     this.transformerData.cqrsId=this.cqrsID;
//     this.transformerData.prospectcode=this.prospectCode;
//     this.transformerData.roomNames=JSON.stringify(this.selectedItems);
//     this.transformerData.flag="INSERT";
//     console.log(this.transformerData)
//     this.ApiService.httpost(this.transformerData,'/Proposal/saveTransformer')
//     .subscribe((res:any)=>{
//       this.getTransformerData();
...
//   getTransformerData() {
//     this.ApiService.httpgetMaster("&ProspectCode="+this.prospectCode+"&cqrsId="+this.cqrsID+"", "/Proposal/getTransformerData").subscribe(
//       (response: any) => {
//         console.log(response.data);
//         this.transformerTableData=response.data;
//         this.sendArray();
//       },
//       (err) => {
//       }
...
// const roomNamesArray = [].concat(...this.transformerTableData.map(item => JSON.parse(item.roomNames))); 
// //this.transformerTableData.map(item => JSON.parse(item.roomNames));
...
//   {
//     this.transformerData.roomNames=JSON.stringify(this.selectedItems);
//     this.transformerData.flag="Update";
//     console.log(this.transformerData)
//     this.ApiService.httpost(this.transformerData,'/Proposal/saveTransformer')
//     .subscribe((res:any)=>{
//       this.getTransformerData();
...
//   {
//     this.transformerData=data;
//     this.transformerData.flag="Delete";
//     console.log(this.transformerData)
//     this.ApiService.httpost(this.transformerData,'/Proposal/saveTransformer')
//     .subscribe((res:any)=>{
//       this.getTransformerData();
...
console.log(this.objRoom , " ....in add to grid")
    this.modelText="Add more transformer to this room";
    this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then(
      (result) => {
        //this.closeResult = `Closed with: ${result}`;
      },
