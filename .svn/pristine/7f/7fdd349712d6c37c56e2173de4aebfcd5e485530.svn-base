...
// import { GensetEntity } from 'src/app/models/proposal/cqrs';
// import { ApiService } from 'src/app/services/api.service';
// @Component({
//   selector: 'app-genset',
//   templateUrl: './genset.component.html',
//   styleUrls: ['./genset.component.scss']
// })
// export class GensetComponent {
//   @Output() arrayEmitter = new EventEmitter<string[]>();
//   @ViewChild('dropdown') dropdown: ElementRef | undefined;

//   @Input() cqrsID:number=0;
//   @Input() prospectCode:string="";
//   gensetData: GensetEntity;
//   gensetTableData: GensetEntity[] = [];
//   options: string[] = [];
//   selectedItems: any[] = [];
//   newItem: string = '';
...
//     this.gensetData = new GensetEntity();
...
//   onSubmit()
//   { 
//     this.gensetData.cqrsId=this.cqrsID;
//     this.gensetData.prospectcode=this.prospectCode;
//     this.gensetData.roomNames=JSON.stringify(this.selectedItems);
//     this.gensetData.flag="INSERT";
//     console.log(this.gensetData)
//     this.ApiService.httpost(this.gensetData,'/Proposal/saveGenset')
//     .subscribe((res:any)=>{
//       this.getGensetData();
...
//   getGensetData() {
//     this.ApiService.httpgetMaster("&ProspectCode="+this.prospectCode+"&cqrsId="+this.cqrsID+"", "/Proposal/getGensetData").subscribe(
//       (response: any) => {
//         console.log(response.data);
//         this.gensetTableData=response.data;
//         this.sendArray();
//       },
//       (err) => {
//       }
...
// const roomNamesArray = [].concat(...this.gensetTableData.map(item => JSON.parse(item.roomNames))); 
// //this.gensetTableData.map(item => JSON.parse(item.roomNames));
...
console.log(this.objRoom , " ....in add to grid")
    this.modelText="Add More Genset to this Room";
    this.modalService.open(content, { ariaLabelledBy: 'modal-basic-title' }).result.then(
      (result) => {
        //this.closeResult = `Closed with: ${result}`;
      },
